#kayan pencere değil ızgaralama yapar
...
#resimler için aynı kod
files= os.listdir(r"C:\Users\seyma\Desktop\media\ssd_img")
img_path_list=[]
for f in files:
    if f.endswith(".jpg"):
        img_path_list.append(os.path.join(r"C:\Users\seyma\Desktop\media\ssd_img", f))
