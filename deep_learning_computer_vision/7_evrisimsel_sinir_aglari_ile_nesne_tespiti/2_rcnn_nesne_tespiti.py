...
image = cv2.imread(r"C:\Users\seyma\Desktop\media\mnist.png")
...
#kutuların tespiti ve modele hazır hale getirme
...
#modeli yükleme ve tahmin etme 
print("siniflandirma")
pickle_in = open("model_trained_new.p", "rb")   
model = pickle.load(pickle_in)
proba = model.predict(proposals)

#tahmin olasılıkları eşik değerine göre ayıklama 
number_list = []
idx = []
