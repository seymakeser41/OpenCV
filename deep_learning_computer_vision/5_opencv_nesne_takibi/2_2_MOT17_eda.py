#ground truth oluşturulacak 
#bu dosya takip algoritmalarının seviyesini göstermek için bir belirteç olacak 
#sonucunda oluşacak gt_new.txt kullanılacak
import pandas as pd
import cv2
import numpy as np
...
#gt.txt içerindeki verilere başlık ekledi
data = pd.read_csv(r"C:\Users\seyma\Desktop\opencv_bolumu\cascade\gt.txt", names = col_list)

#veri içerisindeki sınıfların dağılımı
plt.figure()
sns.countplot(data["class"])

#makaleden bakarak sınıfları anlayabilirsiniz
car = data[data["class"] == 3]

video_path = r"C:\Users\seyma\Desktop\media\MOT17-13-SDP.mp4"
cap = cv2.VideoCapture(video_path)

id1 = 29 #29 numaralı (identity number =29 ) araç takip edilecek
...
for i in range(numberOfImage-1):
    ...
    if ret:
        ...
        #aranılan araca göre filtre oluşturuldu
